...
Focus on content, community, and awareness building.
...
Focus on investor relations, partnerships, and early adoption.
...
### For Investors
1. Start: [One-Pager](sales/one-pager.md)
2. Deep dive: [Investor Pitch](sales/investor-pitch.md)
...
| Phase | When | Focus | Leads |
|-------|------|-------|-------|
| **0** | Now (Feb-Mar) | Foundation | Positioning, messaging, roadmap |
| **1** | Apr-Jun | Prelaunch hype | Content, beta recruitment, emails |
| **2** | Jul-Aug | Launch prep | Affiliate setup, press kit, demo videos |
| **3** | Sep | **LAUNCH** | Intro pricing, press push, affiliate blitz |
| **4+** | Oct+ | Growth | Content, ecosystem, community |
...
- Satisfaction: 4.5+/5
- Expansion pack adoption: 20% of user base
